        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['fio'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['fio']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['phone'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['phone']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['email'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['email']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['birth_date'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['birth_date']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['gender'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['gender']) ?></span>
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['languages'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['languages']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['biography'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['biography']) ?></span>
                <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($error_messages['contract_accepted'])): ?>
                    <span class="field-error-message"><?= htmlspecialchars($error_messages['contract_accepted']) ?></span>
                <?php endif; ?>
            </div>
